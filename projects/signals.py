...
def populate_db(sender, **kwargs):
    ...
    try:
        perm_create = Permission.objects.get( codename="can_create_a_project")
        perm_read = Permission.objects.get( codename="can_read_all_the_project")
        perm_update = Permission.objects.get( codename="can_update_project")
        perm_delete = Permission.objects.get( codename="can_delete_project")
