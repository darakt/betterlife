...
def populate_db(sender, **kwargs):
    ...
    creator, create = User.objects.get_or_create( id=1, username='PLACEHOLDER', first_name= "THIS IS A", last_name= "placeholder", email= "NEVER@USE.FR", is_staff= True, is_active= False, date_joined= "2000-01-01T17:25:57.984Z", role=5)
